                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {toggleIcon ? (
                                    ...
                                    <List size={22} className="dark:text-white" />
                                )}
                            </button>
                        </div>
                    </div>
                ...
                <div className="h-[calc(100vh-40px)]  fixed bg-blue-50 dark:bg-gray-900 top-[48px] left-0 right-0 bottom-0">
                    <div className="search-box flex justify-center mt-3 ">
                        <input
                            type="text"
                            placeholder="Search..."
                            className="p-1 px-3 text-sm border-solid border-blue-400 border-[1px] outline-blue-500 dark:bg-gray-700 dark:border-white dark:outline-none dark:text-white rounded-lg w-3/4"
                        />
                    </div>
                    <div className="menu">
                        <ul className="p-3">
